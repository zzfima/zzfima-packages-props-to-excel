...
namespace Logic
{
    public class ConvertPropsFile
    {
        ...
        {
            var exportToExcel = await ExportToExcel(packagesPropsPath);
        ...
        private async Task<DataTable> ExportToExcel(string packagesPropsPath)
        {
            ...
            foreach (var packageReference in packagesProps.ItemGroup.PackageReferences)
            {
                ...
                {
                    return ((from p in repo.FindPackagesById(packageReference.Update)
